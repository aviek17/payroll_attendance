...
import {updateSalary} from '../Apis/apis'
...
const EmployeePayroll = () => {
    ...
    const handleOpen = (id, firstName, lastName, empId) => {
    ...
    const closeModal = async () => {
        ...
        const res = await updateSalary(datas)
        if (res.data.modifiedCount == 1) {
            // window.alert("Salary Updated")
            Swal.fire({
                icon: 'success',
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        <li>
                                                            <Link className="dropdown-item" onClick={() => { handleOpen(curr._id, curr.firstname, curr.lastname, curr.employeeID) }}><i className="fa fa-edit"></i> Edit</Link>
                ...
                <Box sx={style}>
                    ...
                    <div className="container">
                        ...
                        <div className="container mt-3 d-flex justify-content-end">
                            <Button variant='contained' style={{ width: '180px' }} onClick={closeModal} >
                                Update
                            </Button>
                        </div>
                    </div>
